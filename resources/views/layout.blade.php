...
<head>
    ...
    <link href="{{('public/fontend/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{('public/fontend/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{('public/fontend/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{('public/fontend/css/price-range.css')}}" rel="stylesheet">
    <link href="{{('public/fontend/css/animate.css')}}" rel="stylesheet">
    <link href="{{('public/fontend/css/main.css')}}" rel="stylesheet">
    <link href="{{('public/fontend/css/responsive.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
...
<body>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{('/trang-chu')}}"><img src="./public/fontend/images/logo.png" alt="" /></a>
                        </div>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="./public/fontend/images/product1.jpg" alt="" />
                                        <h2>$56</h2>
    ...
    <script src="{{('public/fontend/js/jquery.js')}}"></script>
    <script src="{{('public/fontend/js/bootstrap.min.js')}}"></script>
    <script src="{{('public/fontend/js/jquery.scrollUp.min.js')}}"></script>
    <script src="{{('public/fontend/js/price-range.js')}}"></script>
    <script src="{{('public/fontend/js/jquery.prettyPhoto.js')}}"></script>
